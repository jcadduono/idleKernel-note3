...
struct max77888_regulator_data max77888_regulators[] = {
       {MAX77888_ESAFEOUT1, &safeout1_init_data,},
       {MAX77888_ESAFEOUT2, &safeout2_init_data,},
       {MAX77888_CHARGER, &charger_init_data,},
};
